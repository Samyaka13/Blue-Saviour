...
import event from '@/assets/upcomingEvents.png'
import event1 from '@/assets/upcomingEvents1.png'
...
import ProfessionalPlanetPalBot from './PPB';
import HeroDB from './HeroDirty';
// import 'swiper/css';
...
const Home: React.FC = () => {
    ...
    const achievements = [
    {
      ...
      description: "Completed initial waste collection",
      icon: "fas fa-leaf",
      category: "Milestone",
      level: "Bronze",
      dateEarned: "2024-01-15",
      impact: "1 kg CO₂ offset",
      progress: 100
    },
    
    {
      ...
      description: "Led 10+ collaborative cleanup initiatives",
      icon: "fas fa-users",
      category: "Leadership",
      level: "Silver",
    ...
    },
    {
      ...
      description: "Achieve 500+ waste items collected",
      icon: "fas fa-globe-americas",
      category: "Impact Goal",
      level: "Platinum",
      dateEarned: null,
      impact: "100 kg CO₂ offset",
      progress: 68
    },
    {
      id: 4,
      title: "Regional Coordinator",
      description: "Organize cleanups across 10+ locations",
    ...
    },
    {
      ...
      description: "Complete advanced environmental certification",
  ...
  const getLevelColor = (level) => {
    switch (level) {
      ...
      case 'Platinum': return 'from-blue-600 to-purple-600';
  ...
  const getLevelBadgeStyle = (level) => {
    switch (level) {
      ...
      case 'Platinum': return 'bg-blue-50 text-blue-800 border-blue-200';
            ...
            <main className="container mx-auto px-4 py-8">
                    ...
                    <div className="relative grid md:grid-cols-2 gap-8 p-8 md:p-12">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="relative w-64 h-64">
                                <div className="absolute inset-0 bg-blue-400 rounded-full opacity-70 animate-pulse"></div>
                                <div className="absolute inset-4 bg-blue-500 rounded-full opacity-80"></div>
                                <div className="absolute inset-8 bg-blue-600 rounded-full opacity-100 flex items-center justify-center">
                ...
                <section id="events" className="mb-12">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-5xl font-bold text-slate-800">Upcoming Events</h2>
                ...
                <section id="impact" className="mb-12">
                    <h2 className="text-5xl font-bold text-slate-800 mb-6">Your Impact</h2>
                    <div className="grid md:grid-cols-3 gap-6">
      ...
      <Card className="border border-slate-200 shadow-sm bg-white">
        <CardHeader className="border-b border-slate-100 pb-6">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-5xl font-semibold text-slate-900 flex items-center gap-3">
                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                  <svg className="w-15 h-15 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <CardDescription className="text-slate-600 mt-2">
                Professional certifications and impact milestones
              </CardDescription>
            </div>
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {achievements.map(achievement => (
              <div 
                key={achievement.id} 
                className={`group relative bg-white rounded-lg border transition-all duration-200 hover:shadow-md cursor-pointer ${
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                      achievement.dateEarned 
                        ? `bg-gradient-to-br ${getLevelColor(achievement.level)}` 
                        : 'bg-slate-200'
                    }`}>
                      <i className={`${achievement.icon} text-lg ${achievement.dateEarned ? 'text-white' : 'text-slate-400'}`}></i>
                    </div>
                    <Badge className={`text-xs font-medium ${getLevelBadgeStyle(achievement.level)}`}>
                      {achievement.level}
                    </Badge>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <h3 className={`font-semibold leading-tight ${
                        achievement.dateEarned ? 'text-slate-900' : 'text-slate-500'
                      }`}>
                        {achievement.title}
                      </h3>
                      <p className={`text-sm mt-1 ${
                        achievement.dateEarned ? 'text-slate-600' : 'text-slate-400'
                      }`}>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        {achievement.dateEarned && (
                          <span className="text-green-600">{achievement.impact}</span>
                        )}
                      </div>
                      
                      {/* Progress Bar for Incomplete */}
                      {!achievement.dateEarned && achievement.progress > 0 && (
                        <div>
                      ...
                      <div className="pt-3 border-t border-slate-100">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs text-slate-600 font-medium">Earned</span>
                          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-slate-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-semibold text-slate-900 mb-1">
                  {achievements.filter(a => a.dateEarned).length}
                </div>
              ...
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-semibold text-blue-900 mb-1">
                  {achievements.filter(a => a.dateEarned && a.level === 'Gold').length}
                </div>
                <div className="text-sm text-blue-700">Gold Level</div>
              </div>
              
              <div className="bg-green-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-semibold text-green-900 mb-1">
                  {Math.round(achievements.filter(a => !a.dateEarned).reduce((sum, a) => sum + a.progress, 0) / achievements.filter(a => !a.dateEarned).length) || 0}%
                </div>
              ...
              <div className="bg-amber-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-semibold text-amber-900 mb-1">
                  {achievements.filter(a => a.dateEarned && a.level === 'Platinum').length}
                </div>
                <div className="text-sm text-amber-700">Platinum Level</div>
              </div>
            </div>
          </div>
        </CardContent>
                ...
                <section className="mb-12">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-5xl text-slate-800">Community Leaderboard</CardTitle>
                ...
                <section id="rewards" className="mb-12">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-5xl font-bold text-slate-800">Rewards Marketplace</h2>
                                        ...
                                        {chatMessages.map((msg, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className={`text-xs ${msg.sender === 'user' ? 'text-blue-100' : 'text-slate-500'
                                                            }`}
                                                    >
                                                        {msg.time}
                                                    </div>
