...
function HeroDB() {
    ...
    const [oceanCleanlinessLevel] = useState(35);
        ...
        <div className=" bg-slate-50">
            ...
            <main className="container mx-auto px-4 py-8">
                <section id="dashboard" className="mb-12 relative overflow-hidden rounded-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-amber-900   to-amber-100 opacity-100"></div>
                    <div
                    ...
                    <div className="relative grid md:grid-cols-2 gap-8 p-8 md:p-12">
                        <div className="text-white">
                            ...
                            <div className="mb-8">
                                <div className="flex items-center mb-2">
                                    ...
                                    <Badge className="ml-2 bg-amber-800 hover:bg-amber-400">65% to Level 2</Badge>
                                </div>
                        ...
                        <div className="flex items-center justify-center">
                            <div className="relative w-64 h-64">
                                ...
                                <div className="absolute inset-4 bg-amber-700 rounded-full opacity-40"></div>
                                <div className="absolute inset-8 bg-amber-600 rounded-full opacity-100 flex items-center justify-center">
